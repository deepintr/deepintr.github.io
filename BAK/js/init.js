...
switch (queryStr) {
  ...
  case "international":
    ...
    break;
  case "download1":
    requestedLink = "https://www.deepin.org/en/download/";
    break;
  case "download2":
    requestedLink = "https://mirrors.kernel.org/deepin-cd/";
    break;
  // Turkish links
  ...
  case "sss":
    requestedLink =
      "https://spectrum.chat/deepintr?thread=9b557ba5-57e2-411e-a703-e4c8472a3cb3";
    break;
